...
Route::group(['middleware' => 'locale'], function() {
    ...
    Route::post('delete-review', [InteractionController::class, 'deleteReview'])->name('deleteReview');

    Route::post('update-review', [InteractionController::class, 'updateReview'])->name('updateReview');
