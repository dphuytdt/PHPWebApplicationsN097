        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex justify-content-between justify-content-md-between align-items-center flex-md-row flex-column">
                    <h3 class="breadcrumb-title">{{__('messages.Reset Password')}}</h3>
                ...
                <div class="account_form register">
                    ...
                    <form id="resetPswForm" method="POST" action="{{route('postResetPassword')}}">
                        ...
                        <div class="default-form-box mb-20">
                            <label>{{__('messages.New Password')}} <span>*</span></label>
                            <input type="password" name="password" id="password" data-label="New Password" value="{{old('password')}}" />
                        </div>
                        <div class="default-form-box mb-20">
                            <label>{{__('messages.New Passwords Confirmation')}}n <span>*</span></label>
