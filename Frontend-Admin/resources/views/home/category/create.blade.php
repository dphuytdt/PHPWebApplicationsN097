...
<div class="container">
    <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="name" class="form-label">Name:  <color style="color: red;">*</color></label>
            <input type="text" class="form-control" id="name" name="name" required>
        </div>
        <div class="mb-3">
            <label for="image" class="form-label">Cover Image <color style="color: red;">*</color></label>
            <div class="row">
                <div class="col-md-7">
        ...
        <div class="mb-3">
            <label for="disabledSelect" class="form-label">Status <color style="color: red;">*</color></label>
            <style type="text/css">
                .form-select{
                    width: 100%;
            ...
            <select id="disabledSelect" name="status" class="form-select" required>
