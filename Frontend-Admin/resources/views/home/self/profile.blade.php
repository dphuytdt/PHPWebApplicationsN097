...
<div class="container">
    <form action="{{route('profile.update', $user['id'])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="birthday" name="birthday" required value="{{$user['user_detail']['birthday']}}">
        </div>
        <div class="mb-3">
            <label for="address" class="form-label">Address</label>
            <input type="text" class="form-control" id="address" name="address" required value="{{$user['user_detail']['address']}}">
        </div>
        <div class="mb-3">
            <label for="phone" class="form-label">Phone</label>
            <input type="text" class="form-control" id="phone" name="phone" required value="{{$user['user_detail']['phone']}}">
        </div>
