...
<div class="container">
    ...
    <form action="{{route('books.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Cover Image <color style="color: red;">* (Only PNG)</color></label>
            <div class="row">
                <div class="col-md-7">
                <input type="file" class="form-control" id="exampleInputPassword1" name="image" accept="image/png" required>
                </div>
                <div class="col-md-5">
